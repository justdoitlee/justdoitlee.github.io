(function() {
        ...
        if (!b.modules.async) {
            ...
            e.prototype = {
                ...
                complete: function(a, f) {
                    ...
                    if (a == "success")
                        this.result = f, this.status = "succeeded", this._notify("success", c.success);
                    else if (a == "failure")
                        this.error =
    ...
    }, m = typeof define === "function"&&!define.amd, n = typeof require === "function" && typeof define === "function" && define.amd;
    if (typeof require === "function" && typeof module !== "undefined" && module.exports)
        ...
        define("jscex-async", ["jscex-builderbase"], function(b, d,
        e) {
